...
//        dismiss() // if any there dismiss it
    ...
    public class func showSubtitle(title:String, subtitle:String, withCancelAndContinue: Bool = false) {
        MakeSubtitleHUD()
    ...
    public class func showWithError(_ errorString:String) {
        MakeFailureHUD()
    ...
    public class func showSuccess(_ successString: String) {
        MakeSuccessHUD()
    ...
    public class func show(_ withCancelAndContinue: Bool = false) {
        MakeProgressHUD()
        MOHUD.me?.show()
        me?.buttonsContainer?.isHidden = !withCancelAndContinue
    }
    /// Show with Status
    public class func showWithStatus(_ status: String, withCancelAndContinue: Bool = false) {
        MakeProgressHUD()
...
//        MOHUDTexts.resetDefaults()
    ...
    public class func setBlurStyle(_ style: UIBlurEffectStyle) {
...
// MARK: - IBActions
extension MOHUD {
    @IBAction private func hideHud(_ sender: AnyObject? = nil) {
        MOHUD.dismiss()
    }
